...
public class CidadeRestController {
	...
	@GetMapping(path = "/cidades", produces = "application/json")
	...
	@GetMapping(path = "/cidades/{id}", produces = "application/json")
	...
	@GetMapping(path = "/cidades/estados/{id}", produces = "application/json")
	...
	@GetMapping(path = "/cidades/filtros", produces = "application/json")
	...
	@PostMapping(path = "/cidades", produces = "application/json")
	@ResponseBody
	...
	@PutMapping(path = "/cidades/{id}", produces = "application/json")
	...
	@DeleteMapping(path = "/cidades/{id}", produces = "application/json")
