...
public class EstadoRestController {
	...
	@GetMapping(path = "/estados/{id}", produces = "application/json")
	...
	@PostMapping(path = "/estados", produces = "application/json")
	@ResponseBody
	...
	@PutMapping(path = "/estados/{id}", produces = "application/json")
	...
	@DeleteMapping(path = "/estados/{id}", produces = "application/json")
